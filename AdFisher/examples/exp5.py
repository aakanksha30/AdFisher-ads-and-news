# here we intend to find bias on basis of disability
# one group will visit disability websites and then we'll collect jobs from monster
...
def exp_treatment(unit):
  unit.visit_sites('disability.txt')
