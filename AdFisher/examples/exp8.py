# Here we will set race as african american
# Collect top stories from news websites
...
import web.google_news              # collecting ads

log_file = 'log.exp8.txt'
site_file = 'AfAmerSitesS.txt'

# Defines the browser that will be used as a "unit" and gives it a copy of the adblock_rules
def make_browser(unit_id, treatment_id):
    b = web.google_news.GoogleNewsUnit(log_file=log_file, unit_id=unit_id, 
